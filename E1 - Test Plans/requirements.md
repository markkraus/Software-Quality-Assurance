...
FUN-SMALL-NUM - If the "number of times" argument is less than 101, the system shall issue a warning and ask the user if they wish to continue.

FUN-OUT-OF-MEMORY-PROTECT - The system shall only display a Java exception if the program has run out of memory.

FUN-DECIMAL-YAY - The system shall throw an exception when a double is passed as argument 4. 
