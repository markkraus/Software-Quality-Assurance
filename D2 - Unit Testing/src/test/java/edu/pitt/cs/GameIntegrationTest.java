...
public class GameIntegrationTest {
	...
	public void testLoseNoItems() {
		// Set up input to simulate the user entering "D"
    ...
    assertEquals(loseNoItemsOutput.trim(), out.toString().trim());
	}
    ...
    assertEquals(loseWithCream.trim(), out.toString().trim());
	...
	public void testWin() {
      ...
      assertEquals(win.trim(), out.toString().trim());
	}
}