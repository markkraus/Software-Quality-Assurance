...
public class CatUnitTest {
  ...
  public void testGetId() {
    ...
    assertEquals("Returned incorrect id.", 1, result);
  }
  ...
  public void testGetName() {
    ...
    assertEquals("Jennyanydots", actualName);
  }
  ...
  public void testRenameCat() {
    ...
    assertEquals("Returned incorrect name after renaming.", "Garfield", newName);

    // Return value of c.toString() is "ID 1. Garfield".
    String expectedToString = "ID 1. Garfield";
    assertEquals("Incorrect toString representation after renaming.", expectedToString, c.toString());
  }
}